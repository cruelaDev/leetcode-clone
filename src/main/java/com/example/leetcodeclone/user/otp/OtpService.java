...
import com.example.leetcodeclone.notification.sms.SmsNotificationService;
import com.example.leetcodeclone.user.dto.ValidatePhoneNumberRequestDto;
...
public class OtpService {
    ...
    @Value("${leetcode.otp.retry-wait-time}")
    private int retryWaitTime;
    @Value("${leetcode.otp.retry-count}")
    private int retryCount;
    @Value("${leetcode.otp.time-to-live}")
    private int timeToLive;
    private final String VERIFICATION_MESSAGE = "Your verification code is: %d \n";
